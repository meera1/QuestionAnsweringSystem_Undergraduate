...
static int index1[];
      ...
      String[] question() //takes a question from the user & returns input[] 
...
for(int n=0;n<4;n++)    
    ...
    */
    ...
    public void compare1(String inputMy[],String arr[][],int ch)
    {
       try{
...
public static void main(String args[]) throws Exception
 ...
 if(ch==0||ch>6)
 {
     ...
     String inputMy[]=z.question();
      
      z.compare1(inputMy, arr,ch);
 } 

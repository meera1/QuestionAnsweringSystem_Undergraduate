 ...
 * and open the template1 in the editor.
 */
package abc;
import java.io.*;
import java.util.*;
...
static int index1[];
           ...
           static String he1[]={"Woodcutter","Hare","Tortoise","Fox"};
           static String she1[]={"Fairy"};
           static int x = 0,max=0,g=0,g1=0;
           static String copy = null;

      String[] question12() //takes a question from the user & returns input[] 
...
return input;
    ...
    public void words12() throws Exception
    {int ch1=0;
...
System.out.println();
 ...
 System.out.println();
         System.out.println("The tagged string");
  for(int e=0;e<g;e++)
        {
            for(int t=0;t<max;t++)
            {
    ...
    /*  for(int w=0;w<x1;w++)
      ...
      */
          ...
          if(!verb1[u].equals("zz"))
      {
       ...
       System.out.println();
        System.out.println("The verbs extracted from passage using tags");
      for(int w=0;w<y1;w++)
...
for(int n=0;n<4;n++)    
   ...
   System.out.println();
   System.out.println();
    System.out.println("The verb array :");
    System.out.println();
    ...
    public void compare12(String inputMy[],String arr[][],int ch)
    {
       try{
...
for(int n=0;n<max;n++)
{
    ...
    break;
case 4:
    if(inputMy[0].equalsIgnoreCase("who"))
    {
...
public static void main(String args[]) throws Exception
  {
      Scanner src=new Scanner(System.in);
      int ch=0;
      dynamicprint z= new dynamicprint();
 ...
 if(ch==0||ch>6)
 {
     ...
     String inputMy[]=z.question12();
      
      z.compare12(inputMy, arr,ch);
 } 
